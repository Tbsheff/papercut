...
export function withStore(callback) {
...
export function papercutNotFoundError(id) {
    return {
...
export function presentPapercut(papercut) {
    return {
        id: papercut.id,
...
export function presentPapercutSummary(papercut) {
...
export function presentOccurrence(occurrence) {
    return {
        id: occurrence.id,
