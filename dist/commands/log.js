...
import { additiveWriteMcp, occurrenceOutputSchema, papercutOutputSchema, presentPapercut, presentOccurrence, schemaVersion, schemaVersionOutput, withStore, } from './shared.js';
    ...
    async run(context) {
        ...
        return withStore((store) => {
            ...
            return {
                ...
                action: result.created ? 'created' : 'occurrence_recorded',
